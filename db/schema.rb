...
ActiveRecord::Schema.define(version: 20140510144350) do
  ...
  create_table "appointments", force: true do |t|
    ...
    t.string   "rep_name"
    t.boolean  "is_dollar_discount"
    t.string   "viewing_code"
    t.decimal  "app_items_total"
    t.decimal  "app_supplies_total"
    t.decimal  "app_insurance_total"
    t.decimal  "app_packing_total"
    t.decimal  "app_subtotal"
    t.decimal  "app_total_tax"
    t.decimal  "app_total_order"
    t.decimal  "app_total_final"
  end
